...
// let agee = null;
// console.log(age, age+3, `the age is ${agee}`);
...
// // let result7 = names.includes('bowzer');
...
// // console.log(ageee == 25);
// // console.log(ageee == 30);
// // console.log(ageee != 30);
// // console.log(ageee > 20);
// // console.log(ageee <= 25);
// // console.log(ageee >= 25);
...
// strict comparison (diffirent types cannot be equal)
